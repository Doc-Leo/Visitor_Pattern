public class TelcoPromo {
    public static void main(String[] args) {
        TelcoSubscription smart = new ConcreteTelco("Smart", 15, 500, false);
        TelcoSubscription globe = new ConcreteTelco("Globe", 10, 450, true);
        TelcoSubscription ditto = new ConcreteTelco("Ditto", 8, 400, true);
